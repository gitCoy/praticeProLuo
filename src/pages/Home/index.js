        ...
        <div className="main ">
          <div className="tech">
            <div className="tech-left-text">
              ...
              <div className="body3">
                Whether your business is oriented towards the B2B or B2C market, we will support it
                in entering China as efficiently as possible. The only thing you need to do is to
                focus on your core business, and we provide the strategies, operations, IT
          ...
          <div className="tech">
            ...
            <div className="tech-right-text">
              ...
              <div className="body3">
                ...
                develop a brand new one to match the needs of the Chinese users. We usually start
                the process with the UX research based on the business model, then we build the
                agile IT-architecture corresponding to the local characteristics. Finally we deliver
          ...
          <div className="solution-left">
            <ul className="solution-text">
              ...
              <li className="body3">
                ...
                establish the action plans by consulting and developing business strategies,
                processes for digital transformation, IT, being the client’s spokespeople,
                constructing local teams etc.{' '}
              </li>
            </ul>
          </div>
        ...
        <div className="service2">
          <ul className="service2-text">
            ...
            <li className="body3">
              ...
              line with Chinese standards, to solve basic structural problems, and build better
              local digital experiences. It is very stable and the security is at the highest, but
              above all, your existing databases can be transferred into a Chinese account easily
              and fast.
            </li>
            <br />
            <li className="body3">
              We will recommend AliCloud when you plan to operate a new product in China, it can
              meet most of the development and data requirements in high security and speed, and
            ...
            <div className="service2-main">
              ...
              <div className="aws">
                <ul className="aws-text">
                  ...
                  <li className="body3">
                    Proxy services such as filing of records for transactions that require a
      ...
      <div className="grid">
        <div className="boss">
          ...
          <div className="boss-text">
            <div className="paragraph1 body3">
              Talk to our experts today, they are here to help.
            </div>
            <div className="paragraph2 body3">
              “The Chinese market is relatively closed, highly digitalized, but with a huge
              potential. Since 2010, we have collaborated with global clients supporting them in
              entering the market. In our experience there are three keys to success:{' '}
            </div>
